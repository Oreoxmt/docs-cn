...
summary: TiDB v5.2.0 在 TPC-C 性能上下降了 4.22%，相比于 v5.1.1。测试环境为 AWS EC2，硬件配置包括 PD、TiKV、TiDB 和 TPC-C 实例。软件版本为 v5.1.1 和 v5.2.0，配置参数相同。测试方案包括部署、数据库创建、数据导入和压力测试。测试结果显示性能下降。
---
