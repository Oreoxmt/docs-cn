...
summary: TiDB v4.0 和 v3.0 在OLAP场景下的性能对比测试报告显示，v4.0 通过智能选择混合读取 TiKV、TiFlash 的数据，性能明显优于仅从 TiKV 读取数据的 v4.0 和 v3.0。测试结果表明，TiDB、TiKV 升级至 4.0 版本后，TPC-H 性能得到了显著提升。在 v4.0 完整的 HTAP 形态下，TPC-H 性能得到的提升幅度更大。
---
