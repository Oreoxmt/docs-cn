...
summary: TiDB 3.0 版本和 2.1 版本在 OLTP 场景下进行了性能对比测试。测试环境为 AWS EC2，使用 Sysbench 向集群导入 16 张表，每张数据 1000 万。测试结果显示，v3.0 在 Point Select、Update Non-Index、Update Index 和 Read Write 测试中均表现优于 v2.1。
---
