...
summary: TiDB v5.1.0 在 TPC-C 性能上提升了 2.8%，比 v5.0.2 更优。测试环境为 AWS EC2，硬件配置包括 PD、TiKV、TiDB 和 TPC-C 实例。软件版本为 v5.0.2 和 v5.1.0，配置参数相同。测试方案包括部署、数据库创建、数据导入和压力测试。测试结果显示 v5.1.0 在 TPC-C 性能上有所提升。
---
