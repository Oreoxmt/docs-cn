...
summary: TiDB v5.4 MPP 模式在 TPC-H 100 GB 数据下的性能比 Greenplum 6.15.0 和 Apache Spark 3.1.1 有 2-3 倍的提升。测试环境包括硬件配置和软件版本，TiDB v5.4 配置了 TiFlash 组件的 MPP 模式。测试结果显示 TiDB v5.4 在各个查询中的处理时间明显低于 Greenplum 6.15.0 和 Apache Spark 3.1.1。
---
