...
summary: TiDB v6.1.0 在 TPC-C 性能测试中相比 v6.0.0 平均提升了 2.85%。不同并发数下，v6.1.0 的 tpmC 提升分别为 2.31%、2.71%、3.86% 和 2.52%。测试环境为 AWS EC2，硬件配置包括 PD、TiKV、TiDB 和 TPC-C 实例。软件版本为 v6.0.0 和 v6.1.0，配置参数相同。 HAProxy 用于负载均衡。
---
